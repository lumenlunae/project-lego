...
function popDialogue(data) {
	...
	if (gbox.getObject("hud", "window_server").toys) {
		gbox.getObject("hud", "window_server").toys["server"].newscene = true;
		gbox.getObject("hud", "window_server").toys["server"].ended = false;
	}
}